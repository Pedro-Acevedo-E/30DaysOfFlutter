...
class PokemonPageResponse {
  ...
  PokemonPageResponse({required this.pokemonListings, required this.next, required this.previous});
  ...
  factory PokemonPageResponse.fromJson(Map<String, dynamic> json) {
    ...
    return PokemonPageResponse(pokemonListings: pokemonListings, next: next, previous: previous);
  }
}