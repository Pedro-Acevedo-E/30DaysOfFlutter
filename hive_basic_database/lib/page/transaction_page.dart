...
class _TransactionPageState extends State<TransactionPage> {
  @override
  void dispose() {
    //Hive.box('transactions').close(); //Close a specific box
    Hive.close(); //Close all our boxes
    super.dispose();
  }
  ...
  Future<void> addTransaction(String name, double amount, bool isExpense) async {
    ...
    box.add(transaction); //This automatically creates a key
